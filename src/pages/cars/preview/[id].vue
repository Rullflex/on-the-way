...
const handleDeleteCard = () => {
  $q.dialog({
    ...
    message: 'Вы уверены, что хотите удалить данные о машине? Пассажиры больше не смогут увидеть эту информацию, если она была использована в предыдущих поездках!',
    persistent: true,
    cancel: true,
  }).onOk(async () => {
    $q.loading.show();
