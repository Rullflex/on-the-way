<template>
  ...
  >
    ...
    <p>
      ...
      персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Горшковым Дмитрием
    ...
    <p>
      ...
      Пользователю веб-сайта <a href="https://poputi.tech">https://poputi.tech</a>.
    </p>
    <p>
    ...
    <p>
      ...
      путем направления Оператору уведомление на адрес электронной почты Оператора libafer99@gmail.com с пометкой
    ...
    <p>
      ...
      уведомление посредством электронной почты на электронный адрес Оператора libafer99@gmail.com с пометкой «Отзыв
    ...
    <p>
      ...
      персональных данных, обратившись к Оператору с помощью электронной почты libafer99@gmail.com.
    </p>
    <p>
    ...
    <p>
      ...
      <a href="https://poputi.tech/privacy/">https://poputi.tech/privacy/</a>.
    </p>
  </div>
</template>
